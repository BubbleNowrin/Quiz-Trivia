        ...
        <div>
            <div className="card text-center mt-5 w-75 mx-auto">
                ...
                <div className="card-body">
                    <p className="card-text">React Router is a state container that is used for current location or an URL. It keeps the track of the location and renders different Route's as it changes. It also gives developers tools to update the location using Link's and the history API. Managing this piece of state is the router's main responsibility. Developers can imagine that a new primitive that lets them compose state is going to enable a few things they couldn't do before!</p>
                </div>
            ...
            <div className="card text-center mt-5 w-75 mx-auto">
                ...
                <div className="card-body">
                    <p className="card-text">The useRef Hook allows to persist values between renders.It can be used to store a mutable value that does not cause a re-render when updated.It can be used to access a DOM element directly.
